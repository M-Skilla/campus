...
public class SearchAnnouncementsAdapter extends RecyclerView.Adapter<SearchAnnouncementsAdapter.ViewHolder> {
    ...
    public SearchAnnouncementsAdapter(List<Announcement> announcements, OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SearchAnnouncementsAdapter.ViewHolder(LayoutInflater
