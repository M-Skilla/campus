...
public class CustomMonthAdapter extends RecyclerView.Adapter<CustomMonthAdapter.MonthViewHolder> {
    ...
    public CustomMonthAdapter(int year) {
        this.year = year;
    }
    ...
    public void onBindViewHolder(@NonNull MonthViewHolder holder, int position) {
        ...
        for (int i = 0; i < 42; i++) {
            ...
            holder.dayViews[i].setTextColor(Color.WHITE);
